...
public abstract class AbstractGeneratorTest extends LightJavaCodeInsightFixtureTestCase {
    @Override
    ...
    protected PsiClass loadTestClassFromFile(String testName, String fileName) {
        ...
        return Optional.ofNullable(PsiUtils.getPublicClassFromFile(sourceFile))
